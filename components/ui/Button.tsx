...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "relative inline-flex items-center justify-center rounded-xl font-black transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 disabled:opacity-50 disabled:pointer-events-none active:scale-95 overflow-hidden group uppercase tracking-widest";
  ...
  const rippleEffect = "absolute inset-0 bg-white/20 scale-0 group-active:scale-100 transition-transform duration-500 rounded-full";
